...
40000cf0:	68 2c 01 00 00       	push   $0x12c
40000cf5:	8d 83 d4 e1 ff ff    	lea    -0x1e2c(%ebx),%eax
40000cfb:	50                   	push   %eax
40000cfc:	e8 20 f5 ff ff       	call   40000221 <printf>
    *addr = val;
40000d01:	c7 05 00 00 00 e0 2c 	movl   $0x12c,0xe0000000
40000d08:	01 00 00 
    yield();
40000d0b:	e8 0b fb ff ff       	call   4000081b <yield>
    printf("ding: the new value at address %x: %d\n", addr, *addr);
40000d10:	83 c4 0c             	add    $0xc,%esp
40000d13:	ff 35 00 00 00 e0    	push   0xe0000000
40000d19:	68 00 00 00 e0       	push   $0xe0000000
40000d1e:	8d 83 04 e2 ff ff    	lea    -0x1dfc(%ebx),%eax
40000d24:	50                   	push   %eax
40000d25:	e8 f7 f4 ff ff       	call   40000221 <printf>

    return 0;
}
40000d2a:	83 c4 10             	add    $0x10,%esp
40000d2d:	b8 00 00 00 00       	mov    $0x0,%eax
40000d32:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000d35:	59                   	pop    %ecx
40000d36:	5b                   	pop    %ebx
40000d37:	5d                   	pop    %ebp
40000d38:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000d3b:	c3                   	ret
40000d3c:	66 90                	xchg   %ax,%ax
