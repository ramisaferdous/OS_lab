...
40000022:	81 c3 d2 3f 00 00    	add    $0x3fd2,%ebx
    va_list ap;
    va_start(ap, fmt);
...
4000005b:	81 c3 99 3f 00 00    	add    $0x3f99,%ebx
    va_list ap;
    va_start(ap, fmt);
...
40000094:	81 c3 60 3f 00 00    	add    $0x3f60,%ebx
    va_list ap;
    va_start(ap, fmt);
...
400001cc:	81 c3 28 3e 00 00    	add    $0x3e28,%ebx
    struct printbuf b;
...
400001f5:	8d 83 8d c1 ff ff    	lea    -0x3e73(%ebx),%eax
...
4000024c:	81 c1 a8 3d 00 00    	add    $0x3da8,%ecx
...
400002ae:	e8 ed 0a 00 00       	call   40000da0 <__udivdi3>
...
400002eb:	e8 d0 0b 00 00       	call   40000ec0 <__umoddi3>
...
40000393:	05 61 3c 00 00       	add    $0x3c61,%eax
...
40000414:	03 94 81 d8 e0 ff ff 	add    -0x1f28(%ecx,%eax,4),%edx
...
40000723:	05 d1 38 00 00       	add    $0x38d1,%eax
...
4000074d:	8d 80 73 c3 ff ff    	lea    -0x3c8d(%eax),%eax
...
40000789:	81 c2 6b 38 00 00    	add    $0x386b,%edx
...
400007b8:	8d 82 73 c3 ff ff    	lea    -0x3c8d(%edx),%eax
...
40000cb9:	81 c3 3b 33 00 00    	add    $0x333b,%ebx
    printf("idle\n");
...
40000cce:	83 c4 08             	add    $0x8,%esp
40000cd1:	68 e8 03 00 00       	push   $0x3e8
40000cd6:	6a 01                	push   $0x1
40000cd8:	e8 1f fb ff ff       	call   400007fc <spawn>
40000cdd:	83 c4 10             	add    $0x10,%esp
40000ce0:	83 f8 ff             	cmp    $0xffffffff,%eax
40000ce3:	74 76                	je     40000d5b <main+0xb6>
        printf("ping in process %d.\n", ping_pid);
40000ce5:	83 ec 08             	sub    $0x8,%esp
40000ce8:	50                   	push   %eax
40000ce9:	8d 83 4e e0 ff ff    	lea    -0x1fb2(%ebx),%eax
40000cef:	50                   	push   %eax
40000cf0:	e8 2c f5 ff ff       	call   40000221 <printf>
40000cf5:	83 c4 10             	add    $0x10,%esp
    else
        printf("Failed to launch ping.\n");

    if ((pong_pid = spawn(2, 1000)) != -1)
40000cf8:	83 ec 08             	sub    $0x8,%esp
40000cfb:	68 e8 03 00 00       	push   $0x3e8
40000d00:	6a 02                	push   $0x2
40000d02:	e8 f5 fa ff ff       	call   400007fc <spawn>
40000d07:	83 c4 10             	add    $0x10,%esp
40000d0a:	83 f8 ff             	cmp    $0xffffffff,%eax
40000d0d:	74 60                	je     40000d6f <main+0xca>
        printf("pong in process %d.\n", pong_pid);
40000d0f:	83 ec 08             	sub    $0x8,%esp
40000d12:	50                   	push   %eax
40000d13:	8d 83 7b e0 ff ff    	lea    -0x1f85(%ebx),%eax
40000d19:	50                   	push   %eax
40000d1a:	e8 02 f5 ff ff       	call   40000221 <printf>
40000d1f:	83 c4 10             	add    $0x10,%esp
    else
        printf("Failed to launch pong.\n");

    if ((ding_pid = spawn(3, 1000)) != -1)
40000d22:	83 ec 08             	sub    $0x8,%esp
40000d25:	68 e8 03 00 00       	push   $0x3e8
40000d2a:	6a 03                	push   $0x3
40000d2c:	e8 cb fa ff ff       	call   400007fc <spawn>
40000d31:	83 c4 10             	add    $0x10,%esp
40000d34:	83 f8 ff             	cmp    $0xffffffff,%eax
40000d37:	74 4a                	je     40000d83 <main+0xde>
        printf("ding in process %d.\n", ding_pid);
40000d39:	83 ec 08             	sub    $0x8,%esp
40000d3c:	50                   	push   %eax
40000d3d:	8d 83 a8 e0 ff ff    	lea    -0x1f58(%ebx),%eax
40000d43:	50                   	push   %eax
40000d44:	e8 d8 f4 ff ff       	call   40000221 <printf>
40000d49:	83 c4 10             	add    $0x10,%esp
    else
        printf("Failed to launch ding.\n");

    return 0;
}
40000d4c:	b8 00 00 00 00       	mov    $0x0,%eax
40000d51:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000d54:	59                   	pop    %ecx
40000d55:	5b                   	pop    %ebx
40000d56:	5d                   	pop    %ebp
40000d57:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000d5a:	c3                   	ret
        printf("Failed to launch ping.\n");
40000d5b:	83 ec 0c             	sub    $0xc,%esp
40000d5e:	8d 83 63 e0 ff ff    	lea    -0x1f9d(%ebx),%eax
40000d64:	50                   	push   %eax
40000d65:	e8 b7 f4 ff ff       	call   40000221 <printf>
40000d6a:	83 c4 10             	add    $0x10,%esp
40000d6d:	eb 89                	jmp    40000cf8 <main+0x53>
        printf("Failed to launch pong.\n");
40000d6f:	83 ec 0c             	sub    $0xc,%esp
40000d72:	8d 83 90 e0 ff ff    	lea    -0x1f70(%ebx),%eax
40000d78:	50                   	push   %eax
40000d79:	e8 a3 f4 ff ff       	call   40000221 <printf>
40000d7e:	83 c4 10             	add    $0x10,%esp
40000d81:	eb 9f                	jmp    40000d22 <main+0x7d>
        printf("Failed to launch ding.\n");
40000d83:	83 ec 0c             	sub    $0xc,%esp
40000d86:	8d 83 bd e0 ff ff    	lea    -0x1f43(%ebx),%eax
40000d8c:	50                   	push   %eax
40000d8d:	e8 8f f4 ff ff       	call   40000221 <printf>
40000d92:	83 c4 10             	add    $0x10,%esp
40000d95:	eb b5                	jmp    40000d4c <main+0xa7>
40000d97:	66 90                	xchg   %ax,%ax
40000d99:	66 90                	xchg   %ax,%ax
40000d9b:	66 90                	xchg   %ax,%ax
40000d9d:	66 90                	xchg   %ax,%ax
40000d9f:	90                   	nop
...
40000dab:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000daf:	8b 6c 24 30          	mov    0x30(%esp),%ebp
40000db3:	8b 74 24 34          	mov    0x34(%esp),%esi
40000db7:	8b 5c 24 38          	mov    0x38(%esp),%ebx
40000dbb:	85 c0                	test   %eax,%eax
40000dbd:	75 19                	jne    40000dd8 <__udivdi3+0x38>
40000dbf:	39 de                	cmp    %ebx,%esi
40000dc1:	73 4d                	jae    40000e10 <__udivdi3+0x70>
40000dc3:	31 ff                	xor    %edi,%edi
40000dc5:	89 e8                	mov    %ebp,%eax
40000dc7:	89 f2                	mov    %esi,%edx
40000dc9:	f7 f3                	div    %ebx
40000dcb:	89 fa                	mov    %edi,%edx
...
40000dd8:	39 c6                	cmp    %eax,%esi
40000dda:	73 14                	jae    40000df0 <__udivdi3+0x50>
40000ddc:	31 ff                	xor    %edi,%edi
40000dde:	31 c0                	xor    %eax,%eax
40000de0:	89 fa                	mov    %edi,%edx
40000de2:	83 c4 1c             	add    $0x1c,%esp
40000de5:	5b                   	pop    %ebx
40000de6:	5e                   	pop    %esi
40000de7:	5f                   	pop    %edi
40000de8:	5d                   	pop    %ebp
...
40000df0:	0f bd f8             	bsr    %eax,%edi
40000df3:	83 f7 1f             	xor    $0x1f,%edi
40000df6:	75 48                	jne    40000e40 <__udivdi3+0xa0>
40000df8:	39 f0                	cmp    %esi,%eax
40000dfa:	72 06                	jb     40000e02 <__udivdi3+0x62>
40000dfc:	31 c0                	xor    %eax,%eax
40000dfe:	39 dd                	cmp    %ebx,%ebp
40000e00:	72 de                	jb     40000de0 <__udivdi3+0x40>
40000e02:	b8 01 00 00 00       	mov    $0x1,%eax
40000e07:	eb d7                	jmp    40000de0 <__udivdi3+0x40>
40000e09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000e10:	89 d9                	mov    %ebx,%ecx
40000e12:	85 db                	test   %ebx,%ebx
40000e14:	75 0b                	jne    40000e21 <__udivdi3+0x81>
40000e16:	b8 01 00 00 00       	mov    $0x1,%eax
40000e1b:	31 d2                	xor    %edx,%edx
40000e1d:	f7 f3                	div    %ebx
40000e1f:	89 c1                	mov    %eax,%ecx
40000e21:	31 d2                	xor    %edx,%edx
40000e23:	89 f0                	mov    %esi,%eax
40000e25:	f7 f1                	div    %ecx
40000e27:	89 c6                	mov    %eax,%esi
40000e29:	89 e8                	mov    %ebp,%eax
40000e2b:	89 f7                	mov    %esi,%edi
40000e2d:	f7 f1                	div    %ecx
40000e2f:	89 fa                	mov    %edi,%edx
40000e31:	83 c4 1c             	add    $0x1c,%esp
40000e34:	5b                   	pop    %ebx
40000e35:	5e                   	pop    %esi
40000e36:	5f                   	pop    %edi
40000e37:	5d                   	pop    %ebp
...
40000e40:	89 f9                	mov    %edi,%ecx
40000e42:	ba 20 00 00 00       	mov    $0x20,%edx
40000e47:	29 fa                	sub    %edi,%edx
40000e49:	d3 e0                	shl    %cl,%eax
40000e4b:	89 44 24 08          	mov    %eax,0x8(%esp)
40000e4f:	89 d1                	mov    %edx,%ecx
40000e51:	89 d8                	mov    %ebx,%eax
40000e53:	d3 e8                	shr    %cl,%eax
40000e55:	89 c1                	mov    %eax,%ecx
40000e57:	8b 44 24 08          	mov    0x8(%esp),%eax
40000e5b:	09 c1                	or     %eax,%ecx
40000e5d:	89 f0                	mov    %esi,%eax
40000e5f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000e63:	89 f9                	mov    %edi,%ecx
40000e65:	d3 e3                	shl    %cl,%ebx
40000e67:	89 d1                	mov    %edx,%ecx
40000e69:	d3 e8                	shr    %cl,%eax
40000e6b:	89 f9                	mov    %edi,%ecx
40000e6d:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
40000e71:	89 eb                	mov    %ebp,%ebx
40000e73:	d3 e6                	shl    %cl,%esi
40000e75:	89 d1                	mov    %edx,%ecx
40000e77:	d3 eb                	shr    %cl,%ebx
40000e79:	09 f3                	or     %esi,%ebx
40000e7b:	89 c6                	mov    %eax,%esi
40000e7d:	89 f2                	mov    %esi,%edx
40000e7f:	89 d8                	mov    %ebx,%eax
40000e81:	f7 74 24 08          	divl   0x8(%esp)
40000e85:	89 d6                	mov    %edx,%esi
40000e87:	89 c3                	mov    %eax,%ebx
40000e89:	f7 64 24 0c          	mull   0xc(%esp)
40000e8d:	39 d6                	cmp    %edx,%esi
40000e8f:	72 1f                	jb     40000eb0 <__udivdi3+0x110>
40000e91:	89 f9                	mov    %edi,%ecx
40000e93:	d3 e5                	shl    %cl,%ebp
40000e95:	39 c5                	cmp    %eax,%ebp
40000e97:	73 04                	jae    40000e9d <__udivdi3+0xfd>
40000e99:	39 d6                	cmp    %edx,%esi
40000e9b:	74 13                	je     40000eb0 <__udivdi3+0x110>
40000e9d:	89 d8                	mov    %ebx,%eax
40000e9f:	31 ff                	xor    %edi,%edi
40000ea1:	e9 3a ff ff ff       	jmp    40000de0 <__udivdi3+0x40>
40000ea6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
40000ead:	00 
40000eae:	66 90                	xchg   %ax,%ax
40000eb0:	8d 43 ff             	lea    -0x1(%ebx),%eax
40000eb3:	31 ff                	xor    %edi,%edi
40000eb5:	e9 26 ff ff ff       	jmp    40000de0 <__udivdi3+0x40>
...
40000ecb:	8b 5c 24 34          	mov    0x34(%esp),%ebx
40000ecf:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000ed3:	8b 74 24 30          	mov    0x30(%esp),%esi
40000ed7:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000edb:	89 da                	mov    %ebx,%edx
40000edd:	85 c0                	test   %eax,%eax
40000edf:	75 17                	jne    40000ef8 <__umoddi3+0x38>
40000ee1:	39 fb                	cmp    %edi,%ebx
40000ee3:	73 53                	jae    40000f38 <__umoddi3+0x78>
40000ee5:	89 f0                	mov    %esi,%eax
40000ee7:	f7 f7                	div    %edi
40000ee9:	89 d0                	mov    %edx,%eax
...
40000ef8:	89 f1                	mov    %esi,%ecx
40000efa:	39 c3                	cmp    %eax,%ebx
40000efc:	73 12                	jae    40000f10 <__umoddi3+0x50>
40000efe:	89 f0                	mov    %esi,%eax
40000f00:	83 c4 1c             	add    $0x1c,%esp
40000f03:	5b                   	pop    %ebx
40000f04:	5e                   	pop    %esi
40000f05:	5f                   	pop    %edi
40000f06:	5d                   	pop    %ebp
...
40000f0f:	00 
40000f10:	0f bd e8             	bsr    %eax,%ebp
40000f13:	83 f5 1f             	xor    $0x1f,%ebp
40000f16:	75 48                	jne    40000f60 <__umoddi3+0xa0>
40000f18:	39 d8                	cmp    %ebx,%eax
40000f1a:	0f 82 d8 00 00 00    	jb     40000ff8 <__umoddi3+0x138>
40000f20:	39 fe                	cmp    %edi,%esi
40000f22:	0f 83 d0 00 00 00    	jae    40000ff8 <__umoddi3+0x138>
40000f28:	89 c8                	mov    %ecx,%eax
40000f2a:	83 c4 1c             	add    $0x1c,%esp
40000f2d:	5b                   	pop    %ebx
40000f2e:	5e                   	pop    %esi
40000f2f:	5f                   	pop    %edi
40000f30:	5d                   	pop    %ebp
40000f31:	c3                   	ret
40000f32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
40000f38:	89 f9                	mov    %edi,%ecx
40000f3a:	85 ff                	test   %edi,%edi
40000f3c:	75 0b                	jne    40000f49 <__umoddi3+0x89>
40000f3e:	b8 01 00 00 00       	mov    $0x1,%eax
40000f43:	31 d2                	xor    %edx,%edx
40000f45:	f7 f7                	div    %edi
40000f47:	89 c1                	mov    %eax,%ecx
40000f49:	89 d8                	mov    %ebx,%eax
40000f4b:	31 d2                	xor    %edx,%edx
40000f4d:	f7 f1                	div    %ecx
40000f4f:	89 f0                	mov    %esi,%eax
40000f51:	f7 f1                	div    %ecx
40000f53:	89 d0                	mov    %edx,%eax
40000f55:	31 d2                	xor    %edx,%edx
40000f57:	eb 94                	jmp    40000eed <__umoddi3+0x2d>
40000f59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000f60:	ba 20 00 00 00       	mov    $0x20,%edx
40000f65:	89 e9                	mov    %ebp,%ecx
40000f67:	29 ea                	sub    %ebp,%edx
40000f69:	d3 e0                	shl    %cl,%eax
40000f6b:	89 54 24 04          	mov    %edx,0x4(%esp)
40000f6f:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
40000f74:	89 44 24 08          	mov    %eax,0x8(%esp)
40000f78:	89 f8                	mov    %edi,%eax
40000f7a:	8b 54 24 04          	mov    0x4(%esp),%edx
40000f7e:	d3 e8                	shr    %cl,%eax
40000f80:	89 c1                	mov    %eax,%ecx
40000f82:	8b 44 24 08          	mov    0x8(%esp),%eax
40000f86:	09 c1                	or     %eax,%ecx
40000f88:	89 d8                	mov    %ebx,%eax
40000f8a:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000f8e:	89 e9                	mov    %ebp,%ecx
40000f90:	d3 e7                	shl    %cl,%edi
40000f92:	89 d1                	mov    %edx,%ecx
40000f94:	d3 e8                	shr    %cl,%eax
40000f96:	89 e9                	mov    %ebp,%ecx
40000f98:	89 7c 24 0c          	mov    %edi,0xc(%esp)
40000f9c:	d3 e3                	shl    %cl,%ebx
40000f9e:	89 c7                	mov    %eax,%edi
40000fa0:	89 d1                	mov    %edx,%ecx
40000fa2:	89 f0                	mov    %esi,%eax
40000fa4:	d3 e8                	shr    %cl,%eax
40000fa6:	89 fa                	mov    %edi,%edx
40000fa8:	89 e9                	mov    %ebp,%ecx
40000faa:	09 d8                	or     %ebx,%eax
40000fac:	d3 e6                	shl    %cl,%esi
40000fae:	f7 74 24 08          	divl   0x8(%esp)
40000fb2:	89 d3                	mov    %edx,%ebx
40000fb4:	f7 64 24 0c          	mull   0xc(%esp)
40000fb8:	89 c7                	mov    %eax,%edi
40000fba:	89 d1                	mov    %edx,%ecx
40000fbc:	39 d3                	cmp    %edx,%ebx
40000fbe:	72 06                	jb     40000fc6 <__umoddi3+0x106>
40000fc0:	75 10                	jne    40000fd2 <__umoddi3+0x112>
40000fc2:	39 c6                	cmp    %eax,%esi
40000fc4:	73 0c                	jae    40000fd2 <__umoddi3+0x112>
40000fc6:	2b 44 24 0c          	sub    0xc(%esp),%eax
40000fca:	1b 54 24 08          	sbb    0x8(%esp),%edx
40000fce:	89 d1                	mov    %edx,%ecx
40000fd0:	89 c7                	mov    %eax,%edi
40000fd2:	89 f2                	mov    %esi,%edx
40000fd4:	29 fa                	sub    %edi,%edx
40000fd6:	19 cb                	sbb    %ecx,%ebx
40000fd8:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
40000fdd:	89 d8                	mov    %ebx,%eax
40000fdf:	d3 e0                	shl    %cl,%eax
40000fe1:	89 e9                	mov    %ebp,%ecx
40000fe3:	d3 ea                	shr    %cl,%edx
40000fe5:	d3 eb                	shr    %cl,%ebx
40000fe7:	09 d0                	or     %edx,%eax
40000fe9:	89 da                	mov    %ebx,%edx
40000feb:	83 c4 1c             	add    $0x1c,%esp
40000fee:	5b                   	pop    %ebx
40000fef:	5e                   	pop    %esi
40000ff0:	5f                   	pop    %edi
40000ff1:	5d                   	pop    %ebp
...
40000ff8:	89 da                	mov    %ebx,%edx
40000ffa:	89 f1                	mov    %esi,%ecx
40000ffc:	29 f9                	sub    %edi,%ecx
40000ffe:	19 c2                	sbb    %eax,%edx
40001000:	89 c8                	mov    %ecx,%eax
40001002:	e9 23 ff ff ff       	jmp    40000f2a <__umoddi3+0x6a>
