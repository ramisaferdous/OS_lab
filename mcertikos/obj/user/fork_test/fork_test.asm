...
400002ae:	e8 ad 0a 00 00       	call   40000d60 <__udivdi3>
...
400002eb:	e8 90 0b 00 00       	call   40000e80 <__umoddi3>
...
40000414:	03 94 81 a0 e0 ff ff 	add    -0x1f60(%ecx,%eax,4),%edx
...
40000cb8:	e8 9e 00 00 00       	call   40000d5b <__x86.get_pc_thunk.si>
40000cbd:	81 c6 37 23 00 00    	add    $0x2337,%esi
static gcc_inline pid_t sys_fork(void)
{
    ...
    asm volatile ("int %2"
40000cc3:	b8 03 00 00 00       	mov    $0x3,%eax
40000cc8:	cd 30                	int    $0x30
    pid_t pid;

    pid = sys_fork();

    if (pid == 0) {
40000cca:	85 db                	test   %ebx,%ebx
40000ccc:	75 52                	jne    40000d20 <main+0x7b>
40000cce:	b8 03 00 00 00       	mov    $0x3,%eax
40000cd3:	cd 30                	int    $0x30
        pid = sys_fork();

        if (pid == 0) {
40000cd5:	85 db                	test   %ebx,%ebx
40000cd7:	75 2a                	jne    40000d03 <main+0x5e>
            printf("This is grandchild, global = %p\n", global_test);
40000cd9:	83 ec 08             	sub    $0x8,%esp
40000cdc:	ff b6 0c 00 00 00    	push   0xc(%esi)
40000ce2:	8d 86 f8 e1 ff ff    	lea    -0x1e08(%esi),%eax
40000ce8:	50                   	push   %eax
40000ce9:	89 f3                	mov    %esi,%ebx
40000ceb:	e8 31 f5 ff ff       	call   40000221 <printf>
40000cf0:	83 c4 10             	add    $0x10,%esp
        global_test = 0x5678;
...
40000cf3:	b8 00 00 00 00       	mov    $0x0,%eax
40000cf8:	8d 65 f4             	lea    -0xc(%ebp),%esp
40000cfb:	59                   	pop    %ecx
40000cfc:	5b                   	pop    %ebx
40000cfd:	5e                   	pop    %esi
40000cfe:	5d                   	pop    %ebp
40000cff:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000d02:	c3                   	ret
            printf("Child forks %d, global = %p\n", pid, global_test);
40000d03:	83 ec 04             	sub    $0x4,%esp
40000d06:	ff b6 0c 00 00 00    	push   0xc(%esi)
40000d0c:	53                   	push   %ebx
40000d0d:	8d 86 48 e0 ff ff    	lea    -0x1fb8(%esi),%eax
40000d13:	50                   	push   %eax
40000d14:	89 f3                	mov    %esi,%ebx
40000d16:	e8 06 f5 ff ff       	call   40000221 <printf>
40000d1b:	83 c4 10             	add    $0x10,%esp
40000d1e:	eb d3                	jmp    40000cf3 <main+0x4e>
        printf("parent forks %d, global = %p\n", pid, global_test);
40000d20:	83 ec 04             	sub    $0x4,%esp
40000d23:	ff b6 0c 00 00 00    	push   0xc(%esi)
40000d29:	53                   	push   %ebx
40000d2a:	8d 86 65 e0 ff ff    	lea    -0x1f9b(%esi),%eax
40000d30:	50                   	push   %eax
40000d31:	89 f3                	mov    %esi,%ebx
40000d33:	e8 e9 f4 ff ff       	call   40000221 <printf>
        global_test = 0x5678;
40000d38:	c7 86 0c 00 00 00 78 	movl   $0x5678,0xc(%esi)
40000d3f:	56 00 00 
        printf("parent global_test1 = %p\n", global_test);
40000d42:	83 c4 08             	add    $0x8,%esp
40000d45:	68 78 56 00 00       	push   $0x5678
40000d4a:	8d 86 83 e0 ff ff    	lea    -0x1f7d(%esi),%eax
40000d50:	50                   	push   %eax
40000d51:	e8 cb f4 ff ff       	call   40000221 <printf>
40000d56:	83 c4 10             	add    $0x10,%esp
40000d59:	eb 98                	jmp    40000cf3 <main+0x4e>

40000d5b <__x86.get_pc_thunk.si>:
40000d5b:	8b 34 24             	mov    (%esp),%esi
40000d5e:	c3                   	ret
40000d5f:	90                   	nop

40000d60 <__udivdi3>:
40000d60:	f3 0f 1e fb          	endbr32
40000d64:	55                   	push   %ebp
40000d65:	57                   	push   %edi
40000d66:	56                   	push   %esi
40000d67:	53                   	push   %ebx
40000d68:	83 ec 1c             	sub    $0x1c,%esp
40000d6b:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000d6f:	8b 6c 24 30          	mov    0x30(%esp),%ebp
40000d73:	8b 74 24 34          	mov    0x34(%esp),%esi
40000d77:	8b 5c 24 38          	mov    0x38(%esp),%ebx
40000d7b:	85 c0                	test   %eax,%eax
40000d7d:	75 19                	jne    40000d98 <__udivdi3+0x38>
40000d7f:	39 de                	cmp    %ebx,%esi
40000d81:	73 4d                	jae    40000dd0 <__udivdi3+0x70>
40000d83:	31 ff                	xor    %edi,%edi
40000d85:	89 e8                	mov    %ebp,%eax
40000d87:	89 f2                	mov    %esi,%edx
40000d89:	f7 f3                	div    %ebx
40000d8b:	89 fa                	mov    %edi,%edx
40000d8d:	83 c4 1c             	add    $0x1c,%esp
40000d90:	5b                   	pop    %ebx
40000d91:	5e                   	pop    %esi
40000d92:	5f                   	pop    %edi
40000d93:	5d                   	pop    %ebp
40000d94:	c3                   	ret
40000d95:	8d 76 00             	lea    0x0(%esi),%esi
40000d98:	39 c6                	cmp    %eax,%esi
40000d9a:	73 14                	jae    40000db0 <__udivdi3+0x50>
40000d9c:	31 ff                	xor    %edi,%edi
40000d9e:	31 c0                	xor    %eax,%eax
40000da0:	89 fa                	mov    %edi,%edx
40000da2:	83 c4 1c             	add    $0x1c,%esp
40000da5:	5b                   	pop    %ebx
40000da6:	5e                   	pop    %esi
40000da7:	5f                   	pop    %edi
40000da8:	5d                   	pop    %ebp
...
40000db0:	0f bd f8             	bsr    %eax,%edi
40000db3:	83 f7 1f             	xor    $0x1f,%edi
40000db6:	75 48                	jne    40000e00 <__udivdi3+0xa0>
40000db8:	39 f0                	cmp    %esi,%eax
40000dba:	72 06                	jb     40000dc2 <__udivdi3+0x62>
40000dbc:	31 c0                	xor    %eax,%eax
40000dbe:	39 dd                	cmp    %ebx,%ebp
40000dc0:	72 de                	jb     40000da0 <__udivdi3+0x40>
40000dc2:	b8 01 00 00 00       	mov    $0x1,%eax
40000dc7:	eb d7                	jmp    40000da0 <__udivdi3+0x40>
40000dc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000dd0:	89 d9                	mov    %ebx,%ecx
40000dd2:	85 db                	test   %ebx,%ebx
40000dd4:	75 0b                	jne    40000de1 <__udivdi3+0x81>
40000dd6:	b8 01 00 00 00       	mov    $0x1,%eax
40000ddb:	31 d2                	xor    %edx,%edx
40000ddd:	f7 f3                	div    %ebx
40000ddf:	89 c1                	mov    %eax,%ecx
40000de1:	31 d2                	xor    %edx,%edx
40000de3:	89 f0                	mov    %esi,%eax
40000de5:	f7 f1                	div    %ecx
40000de7:	89 c6                	mov    %eax,%esi
40000de9:	89 e8                	mov    %ebp,%eax
40000deb:	89 f7                	mov    %esi,%edi
40000ded:	f7 f1                	div    %ecx
40000def:	89 fa                	mov    %edi,%edx
40000df1:	83 c4 1c             	add    $0x1c,%esp
40000df4:	5b                   	pop    %ebx
40000df5:	5e                   	pop    %esi
40000df6:	5f                   	pop    %edi
40000df7:	5d                   	pop    %ebp
...
40000e00:	89 f9                	mov    %edi,%ecx
40000e02:	ba 20 00 00 00       	mov    $0x20,%edx
40000e07:	29 fa                	sub    %edi,%edx
40000e09:	d3 e0                	shl    %cl,%eax
40000e0b:	89 44 24 08          	mov    %eax,0x8(%esp)
40000e0f:	89 d1                	mov    %edx,%ecx
40000e11:	89 d8                	mov    %ebx,%eax
40000e13:	d3 e8                	shr    %cl,%eax
40000e15:	89 c1                	mov    %eax,%ecx
40000e17:	8b 44 24 08          	mov    0x8(%esp),%eax
40000e1b:	09 c1                	or     %eax,%ecx
40000e1d:	89 f0                	mov    %esi,%eax
40000e1f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000e23:	89 f9                	mov    %edi,%ecx
40000e25:	d3 e3                	shl    %cl,%ebx
40000e27:	89 d1                	mov    %edx,%ecx
40000e29:	d3 e8                	shr    %cl,%eax
40000e2b:	89 f9                	mov    %edi,%ecx
40000e2d:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
40000e31:	89 eb                	mov    %ebp,%ebx
40000e33:	d3 e6                	shl    %cl,%esi
40000e35:	89 d1                	mov    %edx,%ecx
40000e37:	d3 eb                	shr    %cl,%ebx
40000e39:	09 f3                	or     %esi,%ebx
40000e3b:	89 c6                	mov    %eax,%esi
40000e3d:	89 f2                	mov    %esi,%edx
40000e3f:	89 d8                	mov    %ebx,%eax
40000e41:	f7 74 24 08          	divl   0x8(%esp)
40000e45:	89 d6                	mov    %edx,%esi
40000e47:	89 c3                	mov    %eax,%ebx
40000e49:	f7 64 24 0c          	mull   0xc(%esp)
40000e4d:	39 d6                	cmp    %edx,%esi
40000e4f:	72 1f                	jb     40000e70 <__udivdi3+0x110>
40000e51:	89 f9                	mov    %edi,%ecx
40000e53:	d3 e5                	shl    %cl,%ebp
40000e55:	39 c5                	cmp    %eax,%ebp
40000e57:	73 04                	jae    40000e5d <__udivdi3+0xfd>
40000e59:	39 d6                	cmp    %edx,%esi
40000e5b:	74 13                	je     40000e70 <__udivdi3+0x110>
40000e5d:	89 d8                	mov    %ebx,%eax
40000e5f:	31 ff                	xor    %edi,%edi
40000e61:	e9 3a ff ff ff       	jmp    40000da0 <__udivdi3+0x40>
40000e66:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
40000e6d:	00 
40000e6e:	66 90                	xchg   %ax,%ax
40000e70:	8d 43 ff             	lea    -0x1(%ebx),%eax
40000e73:	31 ff                	xor    %edi,%edi
40000e75:	e9 26 ff ff ff       	jmp    40000da0 <__udivdi3+0x40>
40000e7a:	66 90                	xchg   %ax,%ax
40000e7c:	66 90                	xchg   %ax,%ax
40000e7e:	66 90                	xchg   %ax,%ax

40000e80 <__umoddi3>:
40000e80:	f3 0f 1e fb          	endbr32
40000e84:	55                   	push   %ebp
40000e85:	57                   	push   %edi
40000e86:	56                   	push   %esi
40000e87:	53                   	push   %ebx
40000e88:	83 ec 1c             	sub    $0x1c,%esp
40000e8b:	8b 5c 24 34          	mov    0x34(%esp),%ebx
40000e8f:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000e93:	8b 74 24 30          	mov    0x30(%esp),%esi
40000e97:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000e9b:	89 da                	mov    %ebx,%edx
40000e9d:	85 c0                	test   %eax,%eax
40000e9f:	75 17                	jne    40000eb8 <__umoddi3+0x38>
40000ea1:	39 fb                	cmp    %edi,%ebx
40000ea3:	73 53                	jae    40000ef8 <__umoddi3+0x78>
40000ea5:	89 f0                	mov    %esi,%eax
40000ea7:	f7 f7                	div    %edi
40000ea9:	89 d0                	mov    %edx,%eax
40000eab:	31 d2                	xor    %edx,%edx
40000ead:	83 c4 1c             	add    $0x1c,%esp
40000eb0:	5b                   	pop    %ebx
40000eb1:	5e                   	pop    %esi
40000eb2:	5f                   	pop    %edi
40000eb3:	5d                   	pop    %ebp
...
40000eb8:	89 f1                	mov    %esi,%ecx
40000eba:	39 c3                	cmp    %eax,%ebx
40000ebc:	73 12                	jae    40000ed0 <__umoddi3+0x50>
40000ebe:	89 f0                	mov    %esi,%eax
40000ec0:	83 c4 1c             	add    $0x1c,%esp
40000ec3:	5b                   	pop    %ebx
40000ec4:	5e                   	pop    %esi
40000ec5:	5f                   	pop    %edi
40000ec6:	5d                   	pop    %ebp
...
40000ecf:	00 
40000ed0:	0f bd e8             	bsr    %eax,%ebp
40000ed3:	83 f5 1f             	xor    $0x1f,%ebp
40000ed6:	75 48                	jne    40000f20 <__umoddi3+0xa0>
40000ed8:	39 d8                	cmp    %ebx,%eax
40000eda:	0f 82 d8 00 00 00    	jb     40000fb8 <__umoddi3+0x138>
40000ee0:	39 fe                	cmp    %edi,%esi
40000ee2:	0f 83 d0 00 00 00    	jae    40000fb8 <__umoddi3+0x138>
40000ee8:	89 c8                	mov    %ecx,%eax
40000eea:	83 c4 1c             	add    $0x1c,%esp
40000eed:	5b                   	pop    %ebx
40000eee:	5e                   	pop    %esi
40000eef:	5f                   	pop    %edi
40000ef0:	5d                   	pop    %ebp
40000ef1:	c3                   	ret
40000ef2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
40000ef8:	89 f9                	mov    %edi,%ecx
40000efa:	85 ff                	test   %edi,%edi
40000efc:	75 0b                	jne    40000f09 <__umoddi3+0x89>
40000efe:	b8 01 00 00 00       	mov    $0x1,%eax
40000f03:	31 d2                	xor    %edx,%edx
40000f05:	f7 f7                	div    %edi
40000f07:	89 c1                	mov    %eax,%ecx
40000f09:	89 d8                	mov    %ebx,%eax
40000f0b:	31 d2                	xor    %edx,%edx
40000f0d:	f7 f1                	div    %ecx
40000f0f:	89 f0                	mov    %esi,%eax
40000f11:	f7 f1                	div    %ecx
40000f13:	89 d0                	mov    %edx,%eax
40000f15:	31 d2                	xor    %edx,%edx
40000f17:	eb 94                	jmp    40000ead <__umoddi3+0x2d>
40000f19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000f20:	ba 20 00 00 00       	mov    $0x20,%edx
40000f25:	89 e9                	mov    %ebp,%ecx
40000f27:	29 ea                	sub    %ebp,%edx
40000f29:	d3 e0                	shl    %cl,%eax
40000f2b:	89 54 24 04          	mov    %edx,0x4(%esp)
40000f2f:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
40000f34:	89 44 24 08          	mov    %eax,0x8(%esp)
40000f38:	89 f8                	mov    %edi,%eax
40000f3a:	8b 54 24 04          	mov    0x4(%esp),%edx
40000f3e:	d3 e8                	shr    %cl,%eax
40000f40:	89 c1                	mov    %eax,%ecx
40000f42:	8b 44 24 08          	mov    0x8(%esp),%eax
40000f46:	09 c1                	or     %eax,%ecx
40000f48:	89 d8                	mov    %ebx,%eax
40000f4a:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000f4e:	89 e9                	mov    %ebp,%ecx
40000f50:	d3 e7                	shl    %cl,%edi
40000f52:	89 d1                	mov    %edx,%ecx
40000f54:	d3 e8                	shr    %cl,%eax
40000f56:	89 e9                	mov    %ebp,%ecx
40000f58:	89 7c 24 0c          	mov    %edi,0xc(%esp)
40000f5c:	d3 e3                	shl    %cl,%ebx
40000f5e:	89 c7                	mov    %eax,%edi
40000f60:	89 d1                	mov    %edx,%ecx
40000f62:	89 f0                	mov    %esi,%eax
40000f64:	d3 e8                	shr    %cl,%eax
40000f66:	89 fa                	mov    %edi,%edx
40000f68:	89 e9                	mov    %ebp,%ecx
40000f6a:	09 d8                	or     %ebx,%eax
40000f6c:	d3 e6                	shl    %cl,%esi
40000f6e:	f7 74 24 08          	divl   0x8(%esp)
40000f72:	89 d3                	mov    %edx,%ebx
40000f74:	f7 64 24 0c          	mull   0xc(%esp)
40000f78:	89 c7                	mov    %eax,%edi
40000f7a:	89 d1                	mov    %edx,%ecx
40000f7c:	39 d3                	cmp    %edx,%ebx
40000f7e:	72 06                	jb     40000f86 <__umoddi3+0x106>
40000f80:	75 10                	jne    40000f92 <__umoddi3+0x112>
40000f82:	39 c6                	cmp    %eax,%esi
40000f84:	73 0c                	jae    40000f92 <__umoddi3+0x112>
40000f86:	2b 44 24 0c          	sub    0xc(%esp),%eax
40000f8a:	1b 54 24 08          	sbb    0x8(%esp),%edx
40000f8e:	89 d1                	mov    %edx,%ecx
40000f90:	89 c7                	mov    %eax,%edi
40000f92:	89 f2                	mov    %esi,%edx
40000f94:	29 fa                	sub    %edi,%edx
40000f96:	19 cb                	sbb    %ecx,%ebx
40000f98:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
40000f9d:	89 d8                	mov    %ebx,%eax
40000f9f:	d3 e0                	shl    %cl,%eax
40000fa1:	89 e9                	mov    %ebp,%ecx
40000fa3:	d3 ea                	shr    %cl,%edx
40000fa5:	d3 eb                	shr    %cl,%ebx
40000fa7:	09 d0                	or     %edx,%eax
40000fa9:	89 da                	mov    %ebx,%edx
40000fab:	83 c4 1c             	add    $0x1c,%esp
40000fae:	5b                   	pop    %ebx
40000faf:	5e                   	pop    %esi
40000fb0:	5f                   	pop    %edi
40000fb1:	5d                   	pop    %ebp
40000fb2:	c3                   	ret
40000fb3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
40000fb8:	89 da                	mov    %ebx,%edx
40000fba:	89 f1                	mov    %esi,%ecx
40000fbc:	29 f9                	sub    %edi,%ecx
40000fbe:	19 c2                	sbb    %eax,%edx
40000fc0:	89 c8                	mov    %ecx,%eax
40000fc2:	e9 23 ff ff ff       	jmp    40000eea <__umoddi3+0x6a>
